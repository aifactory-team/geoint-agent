...
**발행**: 2026-06-13 06시 · **센서**: Sentinel-2 L2A (ESA Copernicus) · 10 m  
...
- 분석 기간 **2017–2026** (10년), 동일 계절 청천 영상 시계열.
- 식생 면적(NDVI>0.3): 39.3% → 42.0% (**+0.26%p/년**).
- 짙은 식생(NDVI>0.55): 21.2% → 25.2% (**+0.42%p/년**).
- 수역(한강): 5.2% → 5.9% (**+0.04%p/년**).
- 변화 핫스팟 **12곳** 식별.
...
---
_AIFactory GEOINT Agent · 2026-06-13 06시 · Sentinel-2 (ESA)_