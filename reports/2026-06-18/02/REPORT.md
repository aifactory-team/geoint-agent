# 최신 위성 인사이트 — 킬라우에아 화산 (하와이) (핫이슈·재해(화산/산불))

**발행**: 2026-06-18 02시 · **분야**: 핫이슈·재해(화산/산불) · **센서**: Sentinel-2 L2A (ESA) · 10 m
**원본 촬영**: 2026-06-15 (구름 32.9%, 신규 위성영상)
...
## 핵심 발견
> **활화산·재해 열 이상 탐지 — SWIR 294화소(용암·활성 화재 의심)**

## 1단계 — 발견 (최신 1장)
- 2026-06-15 촬영 영상에서 핫이슈·재해(화산/산불) 신호 분석.
- SWIR 열 이상 화소: 약 294.
- SWIR(B12) 열 이상 294 화소 — 용암·활성 화재 의심
- 주간 광학 SWIR 기반 신호 — 정밀 확인(열적외/현장) 필요
...
---
_AssiWorks - GEOINT · 2026-06-18 02시 · Sentinel-2 (ESA)_
